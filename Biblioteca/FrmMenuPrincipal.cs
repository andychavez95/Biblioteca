...
namespace Biblioteca
{
    ...
    {
        public FrmMenuPrincipal(LibroFileText libFileTxt, ABB abb)
        {
            InitializeComponent();
        ...
        private void btnRegBook_Click(object sender, EventArgs e)
        {
            ...
            FrmRegistroLibro frmRegistroLibro =
                new FrmRegistroLibro(this.libFileTxt, this.abb);
        ...
        {
            this.Hide();
            FrmBusquedaLibro frmBusquedaLibro = 
                new FrmBusquedaLibro(this.libFileTxt, this.abb);
        ...
        private void loadABB()
        {
            ...
            string rutaCompletaArchivo = this.libFileTxt.getRutCompArch();

            if (File.Exists(rutaCompletaArchivo))
            {
                using (StreamReader sr = new StreamReader(rutaCompletaArchivo))
                {
                    string line;
